...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.LastLoginAt = field.NewString(tableName, "last_login_at")
...
type user struct {
	...
	ALL          field.Asterisk
	ID           field.Int64  // ID
	UserAccount  field.String // 账户
	UserPassword field.String // 用户密码
	UserName     field.String // 用户名
	UserRole     field.String // 权限角色: admin/user
	LastLoginAt  field.String // 最后登陆时间
...
func (u *user) updateTableName(table string) *user {
	...
	u.LastLoginAt = field.NewString(table, "last_login_at")
